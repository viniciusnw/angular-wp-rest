# Quartel Design WordPress Skeleton

## Instruções

Esta estrutura teve algumas modificações para se adaptar ao nosso método de trabalho.

* Para iniciar um novo projeto, crie uma pasta com o nome do projeto no servidor local e insira todo conteudo do do Wordpress Skeleton na pasta do projeto.
* Renomeie o arquivo local-config-sample.php para local-config.php e edite as linhas 18,23 e 24
* O tema deve ser colocado na pasta /content
* O Wordpress deve ser colocado na pasta /wp
